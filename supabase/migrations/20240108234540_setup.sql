...
AS $$
DECLARE
  project_url TEXT := 'https://pfjrjmogbltduzfeftcr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBmanJqbW9nYmx0ZHV6ZmVmdGNyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNTE5MDI1NiwiZXhwIjoyMDMwNzY2MjU2fQ.L2kJ72bHBnEm8GwXYA4lrtredUetwzpoGph-EY-bhlY'; -- full access needed for http request to storage
